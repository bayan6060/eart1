...
public class DataTransfer {
    ...
    public int pseudorandom(int seed, Random r) {
        // setting seed 
        //  long s = 24; 
        r.setSeed(seed);
    ...
    public void upload_data_art(String localPath, String remotePath) {
        try {
            ...
            FileUtils.writeStringToFile(new File("D:/test/sample_art2.txt"), convertArrayToStringMethod(string_array), "UTF-8");
    ...
    private String replaceCharAt(String value, int index) {
...
//        String strFileContents;
        ...
        try {
            ...
            String str = FileUtils.readFileToString(new File("D:/test/sample_art2.txt"), StandardCharsets.UTF_8.name());
            ...
            FileUtils.writeStringToFile(new File("D:/test/sample_out2.txt"), str_converted, "UTF-8");
    ...
    public char deidentify(String word, int index) {
    ...
    public void encrypt_main(String localPath, String remotePath, String secretKey) {
        try {
            ...
            FileUtils.writeStringToFile(new File("D:/test//sample_aes_enc.txt"), encryptedString, "UTF-8");
    ...
    public static void main(String[] args) {
        ...
        try{
         ...
         String decrypted_des = ftp.decrypt_des(encrypted_des, secretKey);
        ...
        // ftp.upload_data_art(localPath + "sample.txt", remotePath);
        // ftp.download_art(localPath + "sample.txt", localPath);
//
        System.out.println("------------------------------------------------");
